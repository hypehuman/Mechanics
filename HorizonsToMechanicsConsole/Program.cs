...
internal class Program
{
    ...
    {
        Console.WriteLine("Writing C# file. Ctrl+C to end");
        ...
        var csFile = "../../../../MechanicsCore/Arrangements/SolarSystem.horizons.cs";
        using (var csWriter = File.CreateText(csFile))
        {
            ...
            csWriter.WriteLine();
            csWriter.WriteLine("partial class SolarSystem");
            csWriter.WriteLine("{");
