...
public class TwoBodies : RandomSimulationInitializer
{
    ...
    {
        return new object?[] { _systemRadius, _totalMass, _totalVolume, _requestedSeed };
    }
    ...
    public override IReadOnlyList<Body> GenerateInitialState(out Vector3D displayBound0, out Vector3D displayBound1)
    {
        ...
        for (int i = 0; i < numBodies; i++)
        {
            ...
            var position = Falling.RandomPointInBall(Random, _systemRadius);
